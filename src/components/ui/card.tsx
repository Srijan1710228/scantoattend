...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "border border-brand-muted/30 bg-brand-black/50 backdrop-blur-sm text-brand-white p-6 transition-all",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-sm text-brand-muted font-sans", className)}
    {...props}
  />
));
